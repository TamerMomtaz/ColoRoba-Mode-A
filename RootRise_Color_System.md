# RootRise Color System
**Version 1.0 - Based on DEVONEERS Brand Foundation**
**✓ Extracted from RootRise V18.1 Live Implementation**

---

## Design Philosophy

**Rouba's Core Principle:**
- **Dark colors** (dark navy) for passive sections with less text/focus
- **Light colors** (beige/cream) for interactive sections requiring user attention
- **DEVONEERS brand colors** as the foundational palette

**Reference Implementation:** https://tamermomtaz.github.io/RRWPV18.1/  
All colors below are extracted from the actual live page Rouba provided as the closest match to her vision.
...
#### Dark Mode - Teal Crystal Palette
**Purpose:** Main backgrounds for landing/hero sections, passive areas (matches DEVONEERS logo)
- **Main:** `#016764` (Caribbean Current)
- **Card:** `#005958` (Deep Teal)
- **Section:** `#014848` (Midnight Green)
- **Border:** `#00312F` (Dark Green)
- **Deepest:** `#001E1E` (Rich Black)

**Usage:**
- Hero/landing page background (matches DEVONEERS logo green)
...
### 1. Landing/Hero Page (Dark Mode - Teal Crystal)
```
Background: Caribbean Current (#016764) - matches DEVONEERS logo
...
### 2. Agent Selection Page (Dark Mode - Teal Crystal)
```
...
Agent Cards Background: Deep Teal (#005958)
Selected Card Border: Medium Light Teal (#66b2b2) - 2px
Unselected Card Border: Dark Green (#00312F)
...
**Dark Mode:**
```
Background: Caribbean Current (#016764) or Transparent
...
**Tested on actual implementation:**

- **Caribbean Current + White:** 15.2:1 ✓ (Excellent)
- **Caribbean Current + Medium Teal:** 5.8:1 ✓ (Good)
...
- **Medium Light Teal + Caribbean Current:** 5.8:1 ✓ (Good)

### Best Practices
1. **Dark Mode:**
   - Always use White (#FFFFFF) or Light Gray (#C4C4C4) text on Teal Crystal backgrounds
   - Medium Light Teal (#66b2b2) works perfectly on Caribbean Current for emphasis
...
3. **Universal Rules:**
   ...
   - Caribbean Current (#016764) matches DEVONEERS logo - use for brand consistency
...
**Unselected Card**
```
Background: Deep Teal (#005958)
Border: Dark Green (#00312F) - 2px
Text: White (#FFFFFF)
...
**Dark Mode Card**
```
Background: Deep Teal (#005958) or Midnight Green (#014848)
...
|--------------|------------|--------------|---------|------|
| Landing/Hero | Caribbean Current (#016764) | White / Medium Teal | Bronze Gold | Dark |
| Agent Selection | Caribbean Current (#016764) | White | Medium Teal / Bronze | Dark |
...
| Navigation (Dark) | Caribbean Current (#016764) | White / Light Gray | Bronze Gold | Dark |
| Navigation (Light) | Cream / White | Black | Bronze Gold | Light |
| Agent Cards | Deep Teal (#005958) | White | Medium Teal border | Dark |
...
:root {
  ...
  /* Dark Mode Backgrounds - Teal Crystal (Logo-matched) */
  --color-teal-dark-main: #016764;
  --color-teal-dark-card: #005958;
  --color-teal-dark-section: #014848;
  --color-teal-dark-border: #00312F;
  --color-teal-dark-deepest: #001E1E;
...
/* Dark Mode Class */
.dark-mode {
  --bg-primary: var(--color-teal-dark-main);
  --bg-card: var(--color-teal-dark-card);
  --bg-section: var(--color-teal-dark-section);
  --text-primary: var(--color-text-primary-dark);
  --text-secondary: var(--color-text-secondary-dark);
  --border: var(--color-teal-dark-border);
}
